    ...
    <main className="min-h-screen bg-backgroundColor flex flex-col items-center justify-center p-6">
      <div className="w-full max-w-3xl flex flex-col items-center space-y-8 text-center">
        ...
        <div className="flex flex-col items-center gap-6">
          ...
          <h1 className="text-4xl font-black tracking-tighter text-textColor uppercase italic">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 w-full">
          ...
          <button
            ...
            className="w-full flex items-center justify-center gap-3 bg-quaternary-color border-2 border-red-500 py-4 px-6 rounded-xl text-red-500 font-bold text-lg hover:bg-red-500 hover:border-red-500 hover:text-quaternary-color transition-all duration-200 shadow-sm active:scale-95"
          >
